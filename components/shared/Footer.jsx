...
const Footer = ({ className, socials = {} }) => {
  const dynamicSocials = [
    {
      label: "Facebook",
      href: socials.facebook || "https://www.facebook.com/",
      src: "/ui/facebook.png",
    },
    {
      label: "WhatsApp",
      href: socials.whatsapp || "https://www.whatsapp.com/",
      src: "/ui/whatsapp.png",
    },
    {
      label: "TikTok",
      href: socials.tiktok || "https://www.tiktok.com/",
      src: "/ui/tiktok.png",
    },
    {
      label: "Instagram",
      href: socials.instagram || "https://www.instagram.com/",
