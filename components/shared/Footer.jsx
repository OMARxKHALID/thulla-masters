...
const CardCharacter = ({
  ...
  const W = "clamp(110px, 30vw, 260px)";
  ...
  return (
    ...
    >
      <div
        ...
        style={{ paddingTop: "clamp(28px, 8vw, 64px)" }}
      >
        <div
          ...
          {[0, 1, 2].map((i) => (
            <div
              ...
              style={{
                ...
                borderBottom: `${i === 1 ? "clamp(11px,3vw,16px)" : "clamp(8px,2.2vw,13px)"} solid ${crownColor}`,
              }}
            />
          ))}
        </div>
        ...
        <div
          ...
          style={{
            width: "100%",
            height: "clamp(185px, 49vw, 340px)",
            background: bodyColor,
            borderRadius: "9999px 9999px 0 0",
            borderTop: `clamp(4px, 1vw, 8px) solid ${bodyBorder}`,
            borderLeft: `clamp(4px, 1vw, 8px) solid ${bodyBorder}`,
            borderRight: `clamp(4px, 1vw, 8px) solid ${bodyBorder}`,
          }}
        >
          {isLeft && (
            <>
          ...
          <div
            ...
            style={{
              ...
              marginTop: "clamp(12px, 3.5vw, 26px)",
            }}
          >
            {isLeft ? (
              <>
...
const iconSize = "clamp(22px, 3vw, 34px)";
...
const Footer = () => (
  <footer
    ...
    style={{
      paddingTop: "clamp(40px, 10vw, 90px)",
      minHeight: "clamp(240px, 62vw, 500px)",
    }}
  >
    <div
    ...
    >
      ...
      <p
        ...
        style={{ fontSize: "clamp(0.5rem, 1.6vw, 0.82rem)" }}
      >
