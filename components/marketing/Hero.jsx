...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative z-10 pt-10 sm:pt-14 lg:pt-20">
      <div
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{ opacity: downloading ? 0.75 : 1, transition: "transform 0.1s, opacity 0.2s" }}
          ...
          >
            {downloading ? (
              <span className="flex items-center justify-center gap-2">
                <svg className="animate-spin w-5 h-5 lg:w-[22px] lg:h-[22px]" viewBox="0 0 24 24" fill="none">
