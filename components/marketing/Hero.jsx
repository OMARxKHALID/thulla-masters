...
/* ── AceCard ────────────────────────────────────────────── */
const AceCard = () => (
  <div className="hero-card-sm" style={cardBase}>
    <span className="card-rank" style={{ position: "absolute", top: "5%", left: "8%", color: "#ef4444" }}>A</span>
    <span className="card-corner-suit" style={{ position: "absolute", top: "20%", left: "8%", color: "#ef4444" }}>♦</span>
    <div style={{ display: "flex", height: "100%", alignItems: "center", justifyContent: "center" }}>
      <span className="card-center-suit" style={{ color: "#ef4444" }}>♦</span>
    </div>
    <span className="card-rank" style={{ position: "absolute", bottom: "5%", right: "8%", color: "#ef4444", transform: "rotate(180deg)" }}>A</span>
  </div>
);
...
const JackCard = () => (
  <div className="hero-card-sm" style={cardBase}>
    <span className="card-rank" style={{ position: "absolute", top: "5%", left: "8%", color: "#111", zIndex: 10 }}>J</span>
    <span className="card-corner-suit" style={{ position: "absolute", top: "20%", left: "8%", color: "#111", zIndex: 10 }}>♠</span>
    <div style={{
    ...
    <span className="card-rank" style={{ position: "absolute", bottom: "5%", right: "8%", color: "#111", transform: "rotate(180deg)" }}>J</span>
  </div>
);

/* ── QueenCard ──────────────────────────────────────────── */
const QueenCard = () => (
  <div className="hero-card-lg" style={cardBase}>
    <span className="card-rank" style={{ position: "absolute", top: "4%", left: "7%", color: "#ef4444", zIndex: 10 }}>Q</span>
    <span className="card-corner-suit" style={{ position: "absolute", top: "17%", left: "7%", color: "#ef4444", zIndex: 10 }}>♦</span>
    <div style={{ position: "absolute", bottom: 0, left: "10%", right: "10%", height: "82%", background: "linear-gradient(180deg,#d9592c 0%,#c04422 100%)", borderRadius: "9999px 9999px 0 0", border: "2px solid #a03518", overflow: "visible" }}>
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "20%", background: "#f0c000", borderBottom: "2px solid #c09000", overflow: "visible", display: "flex", alignItems: "flex-start", justifyContent: "space-evenly", padding: "0 8%", zIndex: 2 }}>
        {[11, 14, 11].map((size, i) => (
          <div key={i} style={{ width: 0, height: 0, borderLeft: `${size === 14 ? 7 : 6}px solid transparent`, borderRight: `${size === 14 ? 7 : 6}px solid transparent`, borderBottom: `${size}px solid #f0c000`, marginTop: `-${size}px` }} />
        ))}
      </div>
    ...
    <span className="card-rank" style={{ position: "absolute", bottom: "3.5%", right: "7%", color: "#ef4444", transform: "rotate(180deg)" }}>Q</span>
  </div>
);
...
const KingCard = () => (
  <div className="hero-card-lg" style={cardBase}>
    <span className="card-rank" style={{ position: "absolute", top: "4%", left: "7%", color: "#ef4444", zIndex: 10 }}>K</span>
    <span className="card-corner-suit" style={{ position: "absolute", top: "17%", left: "7%", color: "#ef4444", zIndex: 10 }}>♥</span>
    ...
    <span className="card-rank" style={{ position: "absolute", bottom: "3.5%", right: "7%", color: "#ef4444", transform: "rotate(180deg)" }}>K</span>
  </div>
);
...
const HeroLogo = () => (
  <div className="flex flex-col items-center select-none" style={{ lineHeight: 0.88 }}>
    <span
      className="font-black uppercase italic text-accent-yellow text-3d-thulla block text-[3.2rem] sm:text-[5rem] md:text-[7rem] lg:text-[9.5rem] xl:text-[11rem]"
      style={{ letterSpacing: "-0.03em" }}
    >
      THULLA
    </span>
    <span
      className="font-black italic text-[#d9cff5] text-3d-masters block text-[2.6rem] sm:text-[4rem] md:text-[5.6rem] lg:text-[7.5rem] xl:text-[9rem]"
    ...
    <>
      <section id="home" className="relative z-10 overflow-hidden">
        <div
          ...
          style={{ maxWidth: "min(96%, 700px)", minHeight: 400 }}
        >
          {/* Floating cards */}
          <motion.div className="absolute z-0" style={{ top: "5%", left: "-4%" }}
            initial={{ rotate: -28 }} animate={{ y: [0, -10, 0], rotate: [-28, -22, -28] }}
            transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}>
            <AceCard />
          </motion.div>

          <motion.div className="absolute z-0" style={{ top: "4%", right: "-4%" }}
            initial={{ rotate: 18 }} animate={{ y: [0, 14, 0], rotate: [18, 24, 18] }}
            transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}>
            <JackCard />
          </motion.div>

          <motion.div className="absolute z-0" style={{ top: "46%", left: "-6%" }}
            initial={{ rotate: -18 }} animate={{ x: [0, 6, 0], y: [0, -8, 0], rotate: [-18, -12, -18] }}
            transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}>
            <QueenCard />
          </motion.div>

          <motion.div className="absolute z-0" style={{ top: "50%", right: "-6%" }}
          ...
          >
            ...
            <div className="mt-4 mb-6 space-y-1.5" style={{ maxWidth: "min(88%, 420px)" }}>
              {[
